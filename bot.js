...
client.on("message" , msg => {
if (msg.content.toLowerCase() === "sağol toxit") {
 msg.reply("Asıl Sen Sağol Ne Demek Dostum Herzaman");
}
});
client.on("guildMemberRemove", async member => {
...
.setTimestamp()
.setFooter('CodAre', 'https://www.canes.cf/images/caneslogo.png');
//https://cnslink.cf
...
const embed = new Discord.RichEmbed()
.setColor('RANDOM')
.setTitle('Hoşgeldin Kuralları Okumayı Unutma Beni Sunucuna Eklemek İçin:https://discord.com/oauth2/authorize?client_id=768856755634831430&scope=bot&permissions=8')
