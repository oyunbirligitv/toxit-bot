...
exports.run = async (client, message, args) => {
  ...
  if(samet == null) return message.channel.send('Kayıt Sistemi eklemek için <`t!kayıt-rol @rol`/`t!kayıt-kanal #kanal`/`t!kayıt-log #kanal`> şeklinde Ayarlıya bilirsiniz. ');
