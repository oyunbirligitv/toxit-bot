...
exports.run = async(client, message, args) => {
  ...
  if (args[0] !== 'aç' && args[0] !== 'kapat') return message.channel.send(`:no_entry: Reklam Filtresini Ayarlamak İçin \`t!reklam-engelleme aç\` | Kapatmak İstiyorsanız \`t!reklam-engelleme kapat\` Yazabilirsiniz`)
